...
contract CurvePoolTest is BaseTest {
    LVBTC private lvBTC;
    ...
    function setUp() public {
        ...
        deal(address(allContracts.lvBTC), address(allContracts.wbtcVault), 1000e8);
    ...
    function depositToCurvePool(uint256 wbtcAmount, uint256 lvBtcAmount) internal {
        ...
        allContracts.lvBTCCurvePool.add_liquidity(amounts, 0); // Assuming minMintAmount is not a concern for the tests.
    }
    ...
    function testDeposit() public {
        ...
        assertEq(
            initialLvBtcBalance - finalLvBtcBalance, lvBtcAmount, "lvBTC balance didn't decrease by the deposi amount"
        );
    ...
    function testSwap() public {
        ...
        assertTrue(
            finalLvBtcBalance >= initialLvBtcBalance + lvBtcAmountReceived, "lvBTC balance increase mismatch after swap"
        );
